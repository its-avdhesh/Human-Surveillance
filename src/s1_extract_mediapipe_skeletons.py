...
def main():
    ...
    # initiate pose estimator (force to use mediapipe)
    pose_cfg = dict(cfg.POSE)
    pose_cfg.pop('name', None)
    pose_estimator = get_pose_estimator('mediapipe', **pose_cfg)
    ...
    for i in loop:
        ...
        # predict mediapipe skeleton and save to file as openpose format
